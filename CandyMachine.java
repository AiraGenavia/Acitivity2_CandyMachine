...
public class CandyMachine {
  ...
  public static void main(String[] args) {
        ...
        System.out.println("1. CHIPS = P 10.00");
        System.out.println("2.  GUM = P 5.00");
        System.out.println("3. COOKIES P 15.00");
        int sel = sc.nextInt();

        if(sel == 1 ){
            System.out.println("You select a CHIPS = P 10.00");
            int chips = 10;
            ...
            System.out.println("You select a GUM = P 5.00");
            int GUM = 5;
            ...
            System.out.println("You select a COOKIES = P 15.00");
            int cookies = 15;
